...
Instance::Instance(Delegate * aDelegate, EndpointId aEndpointId) :
    mDelegate(aDelegate),
    mOwnedCluster(new RegisteredServerCluster<OperationalStateCluster>(aEndpointId, aDelegate))
{
    ...
    if (err != CHIP_NO_ERROR)
    {
        ...
        if (!paths.empty())
        {
            ChipLogError(AppServer, "Failed to unregister OperationalState cluster %u/" ChipLogFormatMEI ": %" CHIP_ERROR_FORMAT,
                         paths[0].mEndpointId, ChipLogValueMEI(paths[0].mClusterId), err.Format());
        }
    }
}
...
void emberAfOperationalStateClusterInitCallback(EndpointId) {}
void emberAfOperationalStateClusterShutdownCallback(EndpointId) {}
...
Protocols::InteractionModel::Status MatterOperationalStateClusterServerPreAttributeChangedCallback(
    const ConcreteAttributePath &, EmberAfAttributeType, uint16_t, uint8_t *)
{
    return Protocols::InteractionModel::Status::Success;
}

void emberAfRvcOperationalStateClusterInitCallback(EndpointId) {}
void emberAfRvcOperationalStateClusterShutdownCallback(EndpointId) {}
...
Protocols::InteractionModel::Status MatterRvcOperationalStateClusterServerPreAttributeChangedCallback(
    const ConcreteAttributePath &, EmberAfAttributeType, uint16_t, uint8_t *)
{
    return Protocols::InteractionModel::Status::Success;
}

void emberAfOvenCavityOperationalStateClusterInitCallback(EndpointId) {}
void emberAfOvenCavityOperationalStateClusterShutdownCallback(EndpointId) {}
...
Protocols::InteractionModel::Status MatterOvenCavityOperationalStateClusterServerPreAttributeChangedCallback(
    const ConcreteAttributePath &, EmberAfAttributeType, uint16_t, uint8_t *)
{
    return Protocols::InteractionModel::Status::Success;
}
